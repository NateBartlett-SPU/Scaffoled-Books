...
// what I added
const friends2 = require("./friends2.json");
friends = friends.concat(friends2.friends);
...
console.log(Object.keys(request)); //prints all the keys of the request object to the console
